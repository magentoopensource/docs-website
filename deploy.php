...
task('deploy:cluster-auth', function () {
    ...
    // Pass the PAT to the remote server and login using --pa_token argument
    // See: https://winkelwagen.de/2023/01/06/maxcluster-cluster-control-restart-php-with-deployer/
...
task('deploy:clear-opcache', function () {
    ...
    // Logout from cluster-control after operations complete
