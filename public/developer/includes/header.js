...
(function () {
    ...
    var searchSvg = '<svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 16C9.77498 15.9996 11.4988 15.4054 12.897 14.312L17.293 18.708L18.707 17.294L14.311 12.898C15.405 11.4997 15.9996 9.77544 16 8C16 3.589 12.411 0 8 0C3.589 0 0 3.589 0 8C0 12.411 3.589 16 8 16ZM8 2C11.309 2 14 4.691 14 8C14 11.309 11.309 14 8 14C4.691 14 2 11.309 2 8C2 4.691 4.691 2 8 2Z" fill="#F26423"/></svg>';
        ...
        '<div class="sticky top-0 z-50 bg-white flex items-center h-16 w-full border-b border-gray-200 shadow-sm">' +
            '<div class="flex items-center justify-between w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">' +
                ...
                '<div class="hidden lg:flex items-center gap-8">' +
                    ...
                    '<a href="/" class="flex items-center justify-center w-10 h-10 hover:bg-off-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange" aria-label="Search the documentation" title="Search the documentation">' + searchSvg + '</a>' +
                '</div>' +
            '</div>' +
        '</div>' +
