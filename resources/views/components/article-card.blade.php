...
<div class="bg-white flex flex-col gap-5 p-6 rounded border-t-4 border-yellow shadow-sm hover:shadow-lg transition-all duration-300 hover:border-orange focus-within:ring-2 focus-within:ring-orange focus-within:ring-opacity-20">
    ...
    <div class="flex flex-col gap-6 items-start justify-start w-full">
        ...
        <div class="flex items-center justify-between w-full">
            <a href="{{ $link }}" class="text-base font-inter-tight leading-[1.5] text-red underline decoration-solid hover:text-orange transition-colors">
                Read more
            </a>
