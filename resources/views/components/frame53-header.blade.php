...
<header class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-8">
                ...
                <div class="flex items-center gap-4 w-[269px]">
                    ...
                    <div class="font-alegreya font-medium text-slate text-base leading-6 whitespace-nowrap">
            ...
            <div class="flex items-center gap-[30px] w-[368px] justify-end pl-2.5 py-2.5">
                <div class="flex-1 bg-white border border-orange rounded-[50px] px-5 py-2.5 relative">
                    <div class="flex items-center justify-between w-full">
                        <button
                            id="docsearch"
                            class="font-alegreya text-black text-base leading-6 bg-transparent border-none outline-none flex-1 text-left focus:outline-none"
                        >
            ...
            {{-- Mobile menu button --}}
            <div class="lg:hidden">
                <button type="button" class="inline-flex items-center justify-center p-2 rounded-md text-slate hover:text-orange hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange">
    ...
    <div class="lg:hidden" id="mobile-menu" style="display: none;">
        <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
            <a href="#" class="block px-3 py-2 text-base font-alegreya text-slate hover:text-orange hover:bg-gray-50 rounded-md">
                Menu item
            </a>
            <a href="#" class="block px-3 py-2 text-base font-alegreya text-slate hover:text-orange hover:bg-gray-50 rounded-md">
                Menu item
