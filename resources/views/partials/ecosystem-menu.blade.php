...
<div class="hidden lg:flex bg-charcoal items-center justify-center py-0 h-10 w-full">
    <div class="max-w-7xl xl:max-w-8xl w-full flex items-center justify-between relative px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex gap-px items-center justify-start shrink-0">
        ...
        <div class="bg-charcoal flex gap-2.5 items-center justify-start px-5 py-2.5 text-sm leading-[1.42]">
            <a href="https://magento-opensource.com/" target="_blank" class="font-inter-tight text-white font-bold no-underline hover:text-orange transition-colors duration-200">Magento Open Source</a>
